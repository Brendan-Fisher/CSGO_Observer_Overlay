      ...
      <div>
        <div className="Tplayers">
          {teamT.map((player, index) => (
            <tr className={"TplayerBlock-"+player.observer_slot%5} key={player.observer_slot}>
              <div className="chart">
                {player.state.health > 0 ? <div className={"bar-"+player.state.health}></div> : <div className="bar-0"></div>}
              <   /div>
              <div>
                {" "}
        ...
        <div className="CTplayers">
          {teamCT.map((player, index) => (
            <tr className="CTplayerBlock" key={player.observer_slot}>
              ...
              <div>
                {player.observer_slot}. {player.name} {player.state.health}{" "}
                {player.state.armor} {player.state.helmet ? "HELMdET" : player.state.armor > 0 ? "NO HELMET" : "NO ARMOR"}{" "}
              </div>
            </tr>
          ))}
        </div>
